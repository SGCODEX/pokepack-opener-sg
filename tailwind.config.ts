  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        pokemonlogo: ['"Luckiest Guy"', 'cursive'],
        code: ['monospace'],
      },
      colors: {
      ...
      keyframes: {
        ...
        'rarity-glow-holo': {
          '0%, 100%': { boxShadow: '0 0 15px 2px rgba(255, 105, 180, 0.8), 0 0 10px 1px rgba(0, 255, 255, 0.8)' },
          '50%': { boxShadow: '0 0 35px 5px rgba(255, 105, 180, 1), 0 0 20px 3px rgba(0, 255, 255, 1)' },
        },
        'swipe-out-left': {
