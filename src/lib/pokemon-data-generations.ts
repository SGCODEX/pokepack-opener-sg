...
// Structure: { pokedexNum, name, typeShorthand, rarityShorthand, pkName, pkCardNum, pkUniqueId }
const generationsCardDetails: Array<{ pokedexNum: string, name: string, typeShorthand: string, rarityShorthand: string, pkName: string, pkCardNum: string, pkUniqueId: string }> = [
  ...
  { pokedexNum: "RC5/RC32", name: "Charizard", typeShorthand: "Fire", rarityShorthand: "Uncommon", pkName: "Charizard", pkCardNum: "RC5", pkUniqueId: "33875" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC6/RC32", name: "Flareon-EX", typeShorthand: "Fire", rarityShorthand: "Ultra Rare", pkName: "Flareon-EX", pkCardNum: "RC6", pkUniqueId: "33916" }, // Note: Pokellector image for RC6 is actually for RC28 full art. Using ID 33916 as it's the EX.
  { pokedexNum: "RC7/RC32", name: "Snorunt", typeShorthand: "Water", rarityShorthand: "Common", pkName: "Snorunt", pkCardNum: "RC7", pkUniqueId: "33895" },
  { pokedexNum: "RC8/RC32", name: "Froslass", typeShorthand: "Water", rarityShorthand: "Uncommon", pkName: "Froslass", pkCardNum: "RC8", pkUniqueId: "33896" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC9/RC32", name: "Raichu", typeShorthand: "Lightning", rarityShorthand: "Common", pkName: "Raichu", pkCardNum: "RC9", pkUniqueId: "33892" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC10/RC32", name: "Dedenne", typeShorthand: "Lightning", rarityShorthand: "Uncommon", pkName: "Dedenne", pkCardNum: "RC10", pkUniqueId: "33897" },
  { pokedexNum: "RC11/RC32", name: "Wobbuffet", typeShorthand: "Psychic", rarityShorthand: "Common", pkName: "Wobbuffet", pkCardNum: "RC11", pkUniqueId: "33898" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC12/RC32", name: "Gulpin", typeShorthand: "Psychic", rarityShorthand: "Common", pkName: "Gulpin", pkCardNum: "RC12", pkUniqueId: "33899" },
  { pokedexNum: "RC13/RC32", name: "Jirachi", typeShorthand: "Psychic", rarityShorthand: "Uncommon", pkName: "Jirachi", pkCardNum: "RC13", pkUniqueId: "33900" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC14/RC32", name: "Espurr", typeShorthand: "Psychic", rarityShorthand: "Common", pkName: "Espurr", pkCardNum: "RC14", pkUniqueId: "33903" },
  { pokedexNum: "RC15/RC32", name: "Meowstic", typeShorthand: "Psychic", rarityShorthand: "Uncommon", pkName: "Meowstic", pkCardNum: "RC15", pkUniqueId: "33904" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC16/RC32", name: "Yveltal", typeShorthand: "Darkness", rarityShorthand: "Uncommon", pkName: "Yveltal", pkCardNum: "RC16", pkUniqueId: "33901" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC17/RC32", name: "Flabébé", typeShorthand: "Fairy", rarityShorthand: "Common", pkName: "Flabebe", pkCardNum: "RC17", pkUniqueId: "33905" },
  { pokedexNum: "RC18/RC32", name: "Floette", typeShorthand: "Fairy", rarityShorthand: "Uncommon", pkName: "Floette", pkCardNum: "RC18", pkUniqueId: "33906" },
  { pokedexNum: "RC19/RC32", name: "Swirlix", typeShorthand: "Fairy", rarityShorthand: "Uncommon", pkName: "Swirlix", pkCardNum: "RC19", pkUniqueId: "33907" },
  { pokedexNum: "RC20/RC32", name: "Slurpuff", typeShorthand: "Fairy", rarityShorthand: "Uncommon", pkName: "Slurpuff", pkCardNum: "RC20", pkUniqueId: "33908" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC21/RC32", name: "Sylveon-EX", typeShorthand: "Fairy", rarityShorthand: "Ultra Rare", pkName: "Sylveon-EX", pkCardNum: "RC21", pkUniqueId: "33909" }, // Regular EX art
  { pokedexNum: "RC22/RC32", name: "Diancie", typeShorthand: "Fairy", rarityShorthand: "Uncommon", pkName: "Diancie", pkCardNum: "RC22", pkUniqueId: "33910" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC23/RC32", name: "Swablu", typeShorthand: "Colorless", rarityShorthand: "Common", pkName: "Swablu", pkCardNum: "RC23", pkUniqueId: "33911" },
  { pokedexNum: "RC24/RC32", name: "Altaria", typeShorthand: "Colorless", rarityShorthand: "Uncommon", pkName: "Altaria", pkCardNum: "RC24", pkUniqueId: "33912" }, // Will be corrected to Holo Rare
  { pokedexNum: "RC25/RC32", name: "Fletchling", typeShorthand: "Colorless", rarityShorthand: "Common", pkName: "Fletchling", pkCardNum: "RC25", pkUniqueId: "33876" }, // Original source had RC6 as 33876, Pokellector has FlareonEX RC28 as 33916. Fletchling RC25 on Pokellector is 33914. Correcting to 33914 for Fletchling.
  // Corrected Fletchling to use Pokellector's RC25 ID:
  ...
  { pokedexNum: "RC26/RC32", name: "Floral Crown", typeShorthand: "I", rarityShorthand: "Common", pkName: "Floral-Crown", pkCardNum: "RC26", pkUniqueId: "33913" },
  { pokedexNum: "RC27/RC32", name: "Wally", typeShorthand: "Su", rarityShorthand: "Uncommon", pkName: "Wally", pkCardNum: "RC27", pkUniqueId: "33918" },
  ...
  { pokedexNum: "RC29/RC32", name: "Pikachu", typeShorthand: "Lightning", rarityShorthand: "Ultra Rare", pkName: "Pikachu", pkCardNum: "RC29", pkUniqueId: "33914" }, // Full Art - This ID is Fletchling RC25. Pikachu Full Art RC29 is 33923.
  // Corrected Pikachu Full Art ID:
  { pokedexNum: "RC29/RC32", name: "Pikachu", typeShorthand: "Lightning", rarityShorthand: "Ultra Rare", pkName: "Pikachu", pkCardNum: "RC29", pkUniqueId: "33923" },
...
const finalGenerationsCardDetails = generationsCardDetails.map(card => {
    // Correct common/uncommon Radiant Collection cards that are Holo on Pokellector
    if (card.pokedexNum === "RC5/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Charizard
    if (card.pokedexNum === "RC8/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Froslass
    if (card.pokedexNum === "RC9/RC32" && card.rarityShorthand === "Common") card.rarityShorthand = "Rare Holo";   // Raichu
    if (card.pokedexNum === "RC11/RC32" && card.rarityShorthand === "Common") card.rarityShorthand = "Rare Holo"; // Wobbuffet
    if (card.pokedexNum === "RC13/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Jirachi
    if (card.pokedexNum === "RC15/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Meowstic
    if (card.pokedexNum === "RC16/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Yveltal
    if (card.pokedexNum === "RC20/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Slurpuff
    if (card.pokedexNum === "RC22/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Diancie
    if (card.pokedexNum === "RC24/RC32" && card.rarityShorthand === "Uncommon") card.rarityShorthand = "Rare Holo"; // Altaria
    return card;
}).filter((card, index, self) => // Remove duplicate entries if any arose from corrections
    index === self.findIndex((c) => (
        c.pokedexNum === card.pokedexNum && c.name === card.name && c.pkUniqueId === card.pkUniqueId // Added pkUniqueId to ensure distinct entries if same name/num existed with diff images
    ))
);


export const generationsCards: PokemonCard[] = finalGenerationsCardDetails.map(detail => {
